...
## How to use?
The use is really simple. To start the timer, pause it and reset it, you have the buttons below. To chat with the AI you have to press the "Study Buddy" button, type wathever you wanna ask and click send or press enter. 

Every other feautre lays behind the "Dashboard" button, just type your tasks and add them with enter, click on the "Select Theme" input box to change the background and use the ambient mixer to modify sound effects and music to your liking.
